...
public class Frame1 {
	...
	void Init_Render() {	
		...
		for(int i = 0 ; i < 14 ; i ++ ) {
			String str = "" ;
			switch(i ){
				case 0 : str += "Chicken Egg" ;break ;
				case 1 : str += "Chicken Meat" ;break ;
				case 2 : str += "Cow Meat" ;break ;
				case 3 : str += "Cow Milk" ;break ;
				case 4 : str += "Duck Egg" ;break ;
				case 5 : str += "Duck Meat" ;break ;
				case 6 : str += "GooseEgg" ;break ;
				case 7 : str += "GooseMeat" ;break ;			
				case 8 : str += "GoatMeat" ;break ;
				case 9 : str += "Beef Rolade" ;break ;
				case 10 : str += "Butter" ;break ;
				case 11 : str += "Ommelet" ;break ;
				case 12 : str += "GoatMilk" ;break ;			
				case 13 : str += "SheepMeat" ;break ;	
			}
			int[] value_inventory = player.showInventory() ;
			lblInventory_value[i] = new JLabel(str + " : " + String.valueOf(value_inventory[i]) );
			lblInventory_value[i].setBounds(panjang_img*player.getMap().getHeight() + 50 + margin_X , 280 + 20*i, 250 , 20);							
		...
		for(int i = 0 ; i <  player.getMap().getWidth() ; i += 1) {
			for(int j = 0 ; j < player.getMap().getHeight() ; j += 1) {		
				...
				switch (player.getMap().getCell(i, j).render() ) {
					...
					case 'b' :
						img_ = new ImageIcon(this.getClass().getResource("/duck_lapar.png")).getImage() ;
						break ;	
					case 'B' :
						img_ = new ImageIcon(this.getClass().getResource("/duck_no_lapar.png")).getImage() ;
						break ;	
						
					case 's' :
						img_ = new ImageIcon(this.getClass().getResource("/cow_lapar.png")).getImage() ;
						break ;	
					case 'S' :
						img_ = new ImageIcon(this.getClass().getResource("/cow_no_lapar.png")).getImage() ;
						break ;	
						
					case 'k' :
						img_ = new ImageIcon(this.getClass().getResource("/goat_lapar.png")).getImage() ;
						break ;	
					case 'K' :
						img_ = new ImageIcon(this.getClass().getResource("/goat_no_lapar.png")).getImage() ;
						break ;	
						
					case 'g' :
						img_ = new ImageIcon(this.getClass().getResource("/goose_lapar.png")).getImage() ;
						break ;	
					case 'G' :
						img_ = new ImageIcon(this.getClass().getResource("/goose_no_lapar.png")).getImage() ;
						break ;	
						
					case 'd' :
						img_ = new ImageIcon(this.getClass().getResource("/sheep_lapar.png")).getImage() ;
						break ;	
					case 'D' :
						img_ = new ImageIcon(this.getClass().getResource("/sheep_no_lapar.png")).getImage() ;
						break ;	
